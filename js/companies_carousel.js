(function () {
  ...
  function showCurrentSlide() {
    ...
    if (window.innerWidth >= 768) {
      const thirdSlideIdx = slideIdx + 2 >= slides.length ? 1 : slideIdx + 2;
      const fourthSlideIdx = slideIdx + 3 >= slides.length ? 2 : slideIdx + 3;
      slideContainer.innerHTML +=
        slides[thirdSlideIdx] + slides[fourthSlideIdx];
    }
  }
